module.exports = {
    ...
    "ensureGuildData": (client, guildID) => {
        ...
        client.guildData.ensure(guildID, { // Ensure "GuildID" has existing data or apply the following default data.
            ...
            swearwords: [{word: "fuck", punishment: "default", punishmentSettings: {}}, {word: "retard", punishment: "default", punishmentSettings: {}}],
        ...
        return client.guildData.get(guildID);
    }
